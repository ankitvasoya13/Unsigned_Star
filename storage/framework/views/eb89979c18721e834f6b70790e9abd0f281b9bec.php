				...
				<div class="card text-center">
					<div class="card-header">
						...
						<?php if($userDetails->end_validity > 0): ?>
							<span class="float-right">Plan expire : <?php echo e(date('m/d/Y', strtotime($userDetails->end_validity))); ?> <span class="text-danger">( <?php echo e(($userDetails->remainingDays < 0)? '0':$userDetails->remainingDays); ?> days remaining)</span> </span>							
						<?php endif; ?>
					</div>
					<div class="card-body">
						<h5>current plan</h5>
						...
						<?php if(count($agreementDetails)): ?>
							<h5 class="card-title"><?php echo e($agreementDetails[0]->plan_name); ?></h5>
							<p class="card-text"><?php echo e($agreementDetails[0]->plan_description); ?></p>
							<p>Track Limit : <?php echo e($agreementDetails[0]->track_limit); ?></p>							
							<p>Auto-renewal : <?php echo e($agreementDetails[0]->status == 'ACTIVE' ? 'ON':'OFF'); ?> 
						...
						<table class="table table-bordered mt-5 text-center">
							...
							<tbody>
								...
								<tr>
									...
									<td><a href="<?php echo e(url('/delete-track/'.$track->id)); ?>" onclick="return confirm('Are you sure? You want to delete.')"><i class="flaticon-trash"></i></a></td>
								</tr>
								<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
							</tbody>
						</table>
								...
								<div class="">
									...
									<div class="col-lg-6 col-md-6">
										<div class="form-pos">
											...
											<small>Image must be 150 x 150 pixel and format must be .jpg.</small><br/>
										</div>
									</div>
						...
						<div class="row mt-5">
							<form class="form-horizontal" method="post" action="<?php echo e(url('/upload-photos')); ?>" enctype="multipart/form-data">
								...
								<div class="col-md-12">
									...
									<span class="orangeBtn modalOpen" data-toggle="modal" data-target="#ImageCropper_modal" data-type="PhotoTab">Upload Image</span>									
									<br />
									<br />
