    ...
    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
        <div class="blog_category_box_wrapper blog_box_wrapper2 float_left">
            ...
            <div class="lest_news_cont_wrapper float_left">
                ...
                <div class="blog-single_cntnt"> {!!mb_substr(html_entity_decode($event->description),0,46) . ((strlen(html_entity_decode($event->description)) > 46) ? '...' : '')!!} <a href="{{ url('/events/eventDetails/'.$event->id) }}"> read more</a> </div>
            </div>
        </div>
    </div>
    @endforeach
