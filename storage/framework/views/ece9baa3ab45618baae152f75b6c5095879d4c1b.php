        ...
        <div class="blog_category_box_wrapper blog_box_wrapper2 float_left">
            ...
            <div class="lest_news_cont_wrapper float_left">
                <div class="blog_heaidng_top">
                    ...
                    <h3> <a href="<?php echo e(url('/events/eventDetails/'.$event->id)); ?>"><?php echo e($event->event_name); ?></a></h3>
                </div>
                <div class="blog-single_cntnt"> <?php echo mb_substr(html_entity_decode($event->description),0,46) . ((strlen(html_entity_decode($event->description)) > 46) ? '...' : ''); ?> <a href="<?php echo e(url('/events/eventDetails/'.$event->id)); ?>"> read more</a> </div>
            </div>
        </div>
    </div>
