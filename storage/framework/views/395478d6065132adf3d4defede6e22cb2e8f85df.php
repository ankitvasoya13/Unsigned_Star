            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="indx_title_left_wrapper ms_cover">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="<?php echo e(url('/profile/'.Request::segment(2))); ?>">Profile</a>
                        </li>
                    ...
                    <div class="type_msg">
                        <div class="input_msg_write">
                            ...
                            <?php if(Session()->get('userType') == 1): ?>
                                ...
                                <input type="hidden" id="artist_id" name="artist_id" value="<?php echo e(Session()->get('userId')); ?>">
                            ...
                            <?php else: ?>
                                ...
                                <input type="hidden" id="panel_member_id" name="panel_member_id" value="<?php echo e(Session()->get('userId')); ?>">                                                         
                            <?php endif; ?>
...
<script>
    ...
    function changeChatUser(id) { 
        if (<?php echo e(Session()->get('userType')); ?> === 1) {
