	...
	<div class="container">
		<div class="row">
			...
			<div class="col-lg-10 offset-lg-1 col-md-12 col-sm-12 col-12">
				<form class="form-horizontal" id="form-contact" method="post" action="<?php echo e(url('/contact-us')); ?>">
					...
					<div class="row">
						...
						<div class="col-md-12">
							<div class="form-m">
								<div class="form-group i-message">
									<div class="g-recaptcha" id="feedback-recaptcha" data-sitekey="<?php echo e(env('RECAPTCHA_SITE_KEY')); ?>" data-callback="recaptchaCallback"></div>
