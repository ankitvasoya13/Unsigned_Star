    ...
    <div class="blog_category_box_wrapper blog_box_wrapper2 float_left">
        ...
        <div class="lest_news_cont_wrapper float_left">
            <div class="blog_heaidng_top">
                ...
                <h3> <a href="<?php echo e(url('/success-stories/storyDetails/'.$story->id)); ?>"><?php echo e($story->title); ?></a></h3>
            </div>

            <div class="blog-single_cntnt"> <?php echo mb_substr(html_entity_decode($story->description),0,46) .
